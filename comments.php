...
<div class="w3-row" id="comment_<?php echo $row['comment_id']; ?>">
	...
	<div class="w3-rest">
		...
		<span class="w3-opacity-min w3-small ts" id="c_ts_<?php echo $row['comment_id']; ?>" style="padding-right: 5px"><?php echo $interval; ?></span>
		...
		<span id="cla_<?php echo $row['comment_id']; ?>">
			...
			<span class="fa fa-thumbs-up w3-text-theme w3-circle"><?php echo likes($row["comment_id"],"comment"); ?>
			</span>
			<?php endif; ?>
		</span>
	</div>
